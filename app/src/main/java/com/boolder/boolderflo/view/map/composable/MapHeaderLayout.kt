...
private fun FiltersRow(
    ...
    val isFFilterActive = fState.problemIds.isNotEmpty()
    ...
    Row {
        ...
        LazyRow(
            ...
            item(key = "f-filter") {
                MapFilterChip(
                    modifier = Modifier.animateItem(),
                    selected = isFFilterActive,
                    label = stringResource(id = R.string.filter_f),
                    iconText = "F",
                    onClick = filtersEventHandler::onFFilterChipClicked
                )
            }
