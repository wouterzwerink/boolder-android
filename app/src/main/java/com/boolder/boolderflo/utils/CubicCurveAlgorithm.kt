...
class CubicCurveAlgorithm {
    ...
    fun controlPointsFromPoints(dataPoints: List<PointD>): List<CubicCurveSegment> {
        ...
        if (count == 1) {
            ...
            //Calculate First Control com.boolder.boolderflo.view.detail.PointD)
            //3P1 = 2P0 + P3
            ...
            //Calculate second Control com.boolder.boolderflo.view.detail.PointD)
            //P2 = 2P1 - P0
            val p2x = (2 * p1x + p0.x)
            val p2y = (2 * p1y + p0.y)
            ...
            //Last control com.boolder.boolderflo.view.detail.PointD)
